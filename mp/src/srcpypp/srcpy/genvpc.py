...
def GenerateVPCs(settings, is_client, module_file_paths, required_file_paths, out_path):
    ...
    with open(out_path, 'w') as fp:
        content = vpctemplate % {'AutoGeneratedModules': auto_generated_modules, 'CoreFiles': core_files}
        fp.write(content)
