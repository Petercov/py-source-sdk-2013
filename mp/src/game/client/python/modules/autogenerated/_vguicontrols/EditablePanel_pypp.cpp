...
void register_EditablePanel_class(){
    ...
    bp::class_< EditablePanel_wrapper, bp::bases< vgui::Panel >, boost::noncopyable >( "EditablePanel", bp::no_init )    
        .def( bp::init< vgui::Panel *, char const * >(( bp::arg("parent"), bp::arg("panelName") )) )    
