...
void register_C_PlayerResource_class(){
    ...
    bp::class_< C_PlayerResource_wrapper, bp::bases< C_BaseEntity >, boost::noncopyable >( "C_PlayerResource", bp::init< >() )    
        ...
        .def( 
            "IsReplay"
            , (bool ( ::C_PlayerResource::* )( int ) )( &::C_PlayerResource::IsReplay )
            , ( bp::arg("index") ) )    
        .def( 
            "OnDataChanged"
        ...
        .def( 
            "Simulate"
            , (void ( ::C_BaseEntity::* )(  ) )(&::C_BaseEntity::Simulate)
            , (void ( C_PlayerResource_wrapper::* )(  ) )(&C_PlayerResource_wrapper::default_Simulate) )    
        .def( 
            "Spawn"
