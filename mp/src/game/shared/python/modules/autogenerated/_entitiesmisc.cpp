...
BOOST_PYTHON_MODULE(_entitiesmisc){
    ...
    bp::enum_< RenderFx_t>("RenderFx_t")
        ...
        .value("kRenderFxDistort", kRenderFxDistort)
        .value("kRenderFxHologram", kRenderFxHologram)
        .value("kRenderFxExplode", kRenderFxExplode)
        .value("kRenderFxGlowShell", kRenderFxGlowShell)
        .value("kRenderFxClampMinScale", kRenderFxClampMinScale)
        .value("kRenderFxEnvRain", kRenderFxEnvRain)
        .value("kRenderFxEnvSnow", kRenderFxEnvSnow)
        .value("kRenderFxSpotlight", kRenderFxSpotlight)
        .value("kRenderFxRagdoll", kRenderFxRagdoll)
...
BOOST_PYTHON_MODULE(_entitiesmisc){
    ...
    bp::class_< SendTable >( "SendTable", bp::no_init )    
        .def( bp::init< >() )    
        .def( bp::init< SendProp *, int, char const * >(( bp::arg("pProps"), bp::arg("nProps"), bp::arg("pNetTableName") )) );
