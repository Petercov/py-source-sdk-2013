...
void register_CPlayerResource_class(){
    ...
    bp::class_< CPlayerResource_wrapper, bp::bases< CBaseEntity >, boost::noncopyable >( "CPlayerResource" )    
        ...
        .def( 
            ...
            , (void ( CPlayerResource_wrapper::* )( ::AI_CriteriaSet & ) )(&CPlayerResource_wrapper::default_ModifyOrAppendCriteria)
            , ( bp::arg("set") ) )    
        .def( 
            "OnRestore"
        ...
        .def( 
            "TraceAttack"
            , (void ( CPlayerResource_wrapper::* )( ::CTakeDamageInfo const &,::Vector const &,::trace_t *,::CDmgAccumulator * ) )(&CPlayerResource_wrapper::TraceAttack)
