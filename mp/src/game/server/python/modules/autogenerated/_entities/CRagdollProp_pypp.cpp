...
void register_CRagdollProp_class(){
    ...
    bp::class_< CRagdollProp_wrapper, bp::bases< CBaseAnimating >, boost::noncopyable >( "CRagdollProp", bp::init< >() )    
        ...
        .def( 
            ...
            , (void ( ::CRagdollProp::* )( ::AI_CriteriaSet & ) )(&::CRagdollProp::ModifyOrAppendCriteria)
            , (void ( CRagdollProp_wrapper::* )( ::AI_CriteriaSet & ) )(&CRagdollProp_wrapper::default_ModifyOrAppendCriteria)
            , ( bp::arg("set") ) )    
        .def( 
            "ObjectCaps"
        ...
        .def( 
            "SetupBones"
            , (void ( ::CRagdollProp::* )( ::matrix3x4_t *,int ) )( &::CRagdollProp::SetupBones )
        ...
        .def( 
            "TraceAttack"
            , (void ( ::CRagdollProp::* )( ::CTakeDamageInfo const &,::Vector const &,::trace_t *,::CDmgAccumulator * ) )( &::CRagdollProp::TraceAttack )
            , ( bp::arg("info"), bp::arg("dir"), bp::arg("ptr"), bp::arg("pAccumulator") ) )    
        .def( 
            "UpdateOnRemove"
