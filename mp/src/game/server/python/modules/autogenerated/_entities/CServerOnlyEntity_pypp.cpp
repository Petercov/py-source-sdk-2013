...
void register_CServerOnlyEntity_class(){
    ...
    bp::class_< CServerOnlyEntity_wrapper, bp::bases< CBaseEntity >, boost::noncopyable >( "CServerOnlyEntity", bp::init< >() )    
        ...
        .def( 
            ...
            , (void ( CServerOnlyEntity_wrapper::* )( ::AI_CriteriaSet & ) )(&CServerOnlyEntity_wrapper::default_ModifyOrAppendCriteria)
            , ( bp::arg("set") ) )    
        .def( 
            "OnRestore"
        ...
        .def( 
            "TraceAttack"
            , (void ( CServerOnlyEntity_wrapper::* )( ::CTakeDamageInfo const &,::Vector const &,::trace_t *,::CDmgAccumulator * ) )(&CServerOnlyEntity_wrapper::TraceAttack)
