...
void register_CPointEntity_class(){
    ...
    bp::class_< CPointEntity_wrapper, bp::bases< CBaseEntity >, boost::noncopyable >( "CPointEntity" )    
        ...
        .def( 
            ...
            , (void ( CPointEntity_wrapper::* )( ::AI_CriteriaSet & ) )(&CPointEntity_wrapper::default_ModifyOrAppendCriteria)
            , ( bp::arg("set") ) )    
        .def( 
            "OnRestore"
        ...
        .def( 
            "TraceAttack"
            , (void ( CPointEntity_wrapper::* )( ::CTakeDamageInfo const &,::Vector const &,::trace_t *,::CDmgAccumulator * ) )(&CPointEntity_wrapper::TraceAttack)
