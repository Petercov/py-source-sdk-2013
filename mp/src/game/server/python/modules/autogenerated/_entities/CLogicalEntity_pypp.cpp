...
void register_CLogicalEntity_class(){
    ...
    bp::class_< CLogicalEntity_wrapper, bp::bases< CServerOnlyEntity >, boost::noncopyable >( "CLogicalEntity" )    
        ...
        .def( 
            ...
            , (void ( CLogicalEntity_wrapper::* )( ::AI_CriteriaSet & ) )(&CLogicalEntity_wrapper::default_ModifyOrAppendCriteria)
            , ( bp::arg("set") ) )    
        .def( 
            "OnRestore"
        ...
        .def( 
            "TraceAttack"
            , (void ( CLogicalEntity_wrapper::* )( ::CTakeDamageInfo const &,::Vector const &,::trace_t *,::CDmgAccumulator * ) )(&CLogicalEntity_wrapper::TraceAttack)
