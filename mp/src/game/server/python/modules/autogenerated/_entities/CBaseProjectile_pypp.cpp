...
struct CBaseProjectile_wrapper : CBaseProjectile, bp::wrapper< CBaseProjectile > {
    ...
    virtual ServerClass* GetServerClass() {
        ...
        if( py_log_overrides.GetBool() )
            Msg("Calling GetServerClass(  ) of Class: CBaseProjectile\n");
...
void register_CBaseProjectile_class(){
    ...
    bp::class_< CBaseProjectile_wrapper, bp::bases< CBaseAnimating >, boost::noncopyable >( "CBaseProjectile", bp::init< >() )    
        ...
        .def( 
            ...
            , (void ( CBaseProjectile_wrapper::* )( ::AI_CriteriaSet & ) )(&CBaseProjectile_wrapper::default_ModifyOrAppendCriteria)
            , ( bp::arg("set") ) )    
        .def( 
            "OnRestore"
        ...
        .def( 
            "TraceAttack"
            , (void ( CBaseProjectile_wrapper::* )( ::CTakeDamageInfo const &,::Vector const &,::trace_t *,::CDmgAccumulator * ) )(&CBaseProjectile_wrapper::TraceAttack)
