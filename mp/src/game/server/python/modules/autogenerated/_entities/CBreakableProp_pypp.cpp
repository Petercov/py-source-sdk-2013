...
void register_CBreakableProp_class(){
    ...
    bp::class_< CBreakableProp_wrapper, bp::bases< CBaseProp >, boost::noncopyable >( "CBreakableProp", bp::no_init )    
        ...
        .def( 
            ...
            , (void ( CBreakableProp_wrapper::* )( ::AI_CriteriaSet & ) )(&CBreakableProp_wrapper::default_ModifyOrAppendCriteria)
            , ( bp::arg("set") ) )    
        .def( 
            "OnRestore"
        ...
        .def( 
            "TraceAttack"
            , (void ( CBreakableProp_wrapper::* )( ::CTakeDamageInfo const &,::Vector const &,::trace_t *,::CDmgAccumulator * ) )(&CBreakableProp_wrapper::TraceAttack)
