...
void register_CBaseFilter_class(){
    ...
    bp::class_< CBaseFilter_wrapper, bp::bases< CLogicalEntity >, boost::noncopyable >( "CBaseFilter", bp::no_init )    
        ...
        .def( 
            ...
            , (void ( CBaseFilter_wrapper::* )( ::AI_CriteriaSet & ) )(&CBaseFilter_wrapper::default_ModifyOrAppendCriteria)
            , ( bp::arg("set") ) )    
        .def( 
            "OnRestore"
        ...
        .def( 
            "TraceAttack"
            , (void ( CBaseFilter_wrapper::* )( ::CTakeDamageInfo const &,::Vector const &,::trace_t *,::CDmgAccumulator * ) )(&CBaseFilter_wrapper::TraceAttack)
